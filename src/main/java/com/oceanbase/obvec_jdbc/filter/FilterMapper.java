package com.oceanbase.obvec_jdbc.filter;
...
public class FilterMapper {
    ...
    /**
     * Converts a Filter to OceanBase JSON filter format.
     * The result is a JSONArray containing the filter structure for OceanBase's bool query.
     *
     * @param filter The filter to convert
     * @return JSONArray containing the filter structure, or null if filter is null
     */
    public static JSONArray toOceanBaseJson(Filter filter) {
        if (filter == null) {
            return null;
        }
        ...
        // Process the filter and add conditions to mustArray
