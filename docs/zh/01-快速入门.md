...
> 阅读顺序：[00-文档目录](00-文档目录.md) → **01 快速入门** → [02-项目与架构](02-项目与架构.md) → [03-混合搜索](03-混合搜索.md) → [04-Filter过滤](04-Filter过滤.md)  
> English: [01-getting-started](../en/01-getting-started.md)
...
详细说明见 [03-混合搜索](03-混合搜索.md) 与 [04-Filter过滤](04-Filter过滤.md)。
...
特殊语法仍可用 `queryDsl()` / `knnDsl()` 传入原始 JSON 兜底。详见 **[05 · HYBRID_SEARCH DSL 语法](05-HYBRID_SEARCH-DSL语法.md)**（完整 JSON 规则与示例）。

## 下一步

| 文档 | 内容 |
|------|------|
| [02-项目与架构](02-项目与架构.md) | 包结构、API 速查、测试 |
| [03-混合搜索](03-混合搜索.md) | HYBRID_SEARCH、版本要求、兼容模式 |
| [05-HYBRID_SEARCH DSL 语法](05-HYBRID_SEARCH-DSL语法.md) | JSON 语法规则、bool/knn/rank、完整示例 |
| [04-Filter过滤](04-Filter过滤.md) | 过滤条件 DSL |
